...
define i32 @main() #0 {
  ...
  %1 = load i32* %y, align 4, !dbg !18
  %2 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([11 x i8]* @.str, i32 0, i32 0), i32 %1), !dbg !18
  ret i32 0, !dbg !19
}
...
!0 = metadata !{i32 786449, metadata !1, i32 12, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 false, metadata !"", i32 0, metadata !2, metadata !2, metadata !3, metadata !2, metadata !2, metadata !""} ; [ DW_TAG_compile_unit ] [/home/student/deadfunc.c] [DW_LANG_C99]
!1 = metadata !{metadata !"deadfunc.c", metadata !"/home/student"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4, metadata !9}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"neverCalled", metadata !"neverCalled", metadata !"", i32 3, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @neverCalled, null, null, metadata !2, i32 3} ; [ DW_TAG_subprogram ] [line 3] [def] [neverCalled]
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/student/deadfunc.c]
